...
struct WrappedHStack<Data, V>: View where Data: RandomAccessCollection, V: View {
    
    // MARK: - Properties
    typealias ViewGenerator = (Data.Element) -> V
    ...
    @State private var totalHeight: CGFloat
     ...
     init(_ models: Data, horizontalSpacing: CGFloat = 4, verticalSpacing: CGFloat = 4,
